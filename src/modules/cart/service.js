 ...
 * @returns {*}
 */
export const getContinentCode = cc => request.get(`/spiro-app-control/v1/get-continent-code-for-country?cc=${cc}`);

/**
 * Get Zones
 * @returns {*}
 */
export const getZones = () => request.get(`/spiro-app-control/v1/zones`);
