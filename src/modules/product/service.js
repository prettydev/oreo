 ...
 * @returns {*}
 */
export const getRatingProductReviews = product_id => request.get(`/spiro-app-control/v1/rating-count?product_id=${product_id}`);

/**
 *  Get rating product reviews
 * @returns {*}
 */
export const addProductReviews = data => request.post(`/spiro-app-control/v1/reviews`, data);
