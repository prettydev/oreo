 ...
 * @returns {*}
 */
export const paymentStripe = data => request.post(`/spiro-app-control/v1/payment-stripe`, data);
 ...
 */
export const processPayment = (data) => request.post(`spiro-app-control/v1/process_payment`, data);
