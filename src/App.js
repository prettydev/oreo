...
class App extends Component<Props> {
  ...
  componentDidMount() {
    ...
    const { apiKey, userName, userSender } = this.props
    SendOtp.setBody(userName, userSender, apiKey);
  ...
  onOpened(openResult) {
    ...
    NotificationHandler.setNotificationHandler(true);
  }
  ...
  onIds(device) {
    ...
    try {
      AsyncStorage.setItem('user_token', device.userId);
    } catch (e) {
      // saving error
    }
  }
